...
<a href="https://www.linkedin.com/in/curtis-petersen/">
  <img src="images/linkedin.svg" alt="Curtis Petersen LinkedIn" class="center" style="width:42px;height:42px;border:20px;">
</a>

<a href="https://github.com/curtisPetersen">
  <img src="images/GitHub_Icon.png" alt="Curtis Petersen GitHub" class="center" style="width:42px;height:42px;border:20px;">
</a>

<a href="mailto:CurtisLPetersen@gmail.com">
  <img src="images/envelope-open-text.svg" alt="Curtis Petersen Email" class="center" style="width:42px;height:42px;border:20px;">
</a>
...
* Mobile health for obesity wellness intervention 
    ...
    + Examined changes in physical activities in older obese adults
    + Examined feasibility and acceptability of mHealth use in older adults
...
* Carotid Artery Dissection
    + Using claims data from Centers For Medicare and Medicaid I've examined the association of carotid artery dissection with other diagnosis to examine when it occurs.
    + Examined how it might be associated with spinal manipulation.

* Mortality Prediction 
    + Using claims data from Centers For Medicare and Medicaid I've developed prediction models for mortality from inpatient and outpatient utilization.
    + Machine learning and big data analytic pipeline.
...
* Use of a EHR embedded decision aid for stroke prevention in atrial fibrillation
...
* Changing medication use in elderly in nursing homes
    + Examined longitudinal use of medications in those with and without dementia
    + Worked with industry partners to answer questions on use
    
* Lead student government as President of the Graduate Student Council
    + I led efforts to create the first diversity leadership chair
    + Worked with administration to provide leadership training for faculty mentors
    + Advocated for new graduate housing
...
```{r}
tags$iframe(style="height:1000px; width:100%; scrolling=yes", src = "Curtis_Petersen_CV.pdf")
```
